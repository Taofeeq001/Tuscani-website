    ...
    <div className='w-1/2'>
        ...
        <div className='flex flex-col gap-3'>
            <div className='flex gap-1'>
                <TbUsersGroup className='text-[orange]'/>
                <p><b>Number of Group:</b> 15 - 30</p>
            </div>
            <div className='flex gap-1'>
                <TbCup className='text-[orange]'/>
                <p><b>Duration:</b> 15 hours and 45 minutes</p>
            </div>
            <div className='flex gap-1'>
                <TbLocation className='text-[orange]'/>
                <p><b>Departure and Arriving Area:</b> Lucca</p>
            </div>
            <div className='flex gap-1'>
                <TbUser className='text-[orange]'/>
                <p><b>Guide Services:</b> Included</p>
            </div>
            <div className='flex gap-1'>
                <TbLanguage className='text-[orange]'/>
                <p><b>Language:</b> English and Italian</p>
            </div>
            <div className='flex gap-1'>
                <TbCurrency className='text-[orange]'/>
                <p><b>Entry Fees:</b> Lorem Ipsum</p>
            </div>
            <div className='flex gap-1'>
                <TbBus className='text-[orange]'/>
