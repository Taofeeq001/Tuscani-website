...
import Details from '../luccaBike/Details'
      ...
      <div className='lg:px-[10%]'>
        ...
        <div className='flex gap-[3rem] lg:flex-row flex-col'>
          <div className='flex flex-col gap-2 lg:w-1/2 w-full'>
            <Image height={450} width={450} className='w-full flex justify-start' src={"/Images/l1.svg"} />
            <div className='grid lg:grid-cols-3 md:grid-cols-3 grid-cols-3 w-full gap-5'>
              <Image height={100} width={200} src={"/Images/l2.svg"} />
              <Image height={100} width={200} src={"/Images/l3.svg"} />
              <Image height={100} width={200} src={"/Images/l4.svg"} />
            </div>
          </div>
          <div className='flex flex-col lg:w-1/2 w-full gap-2'>
            <h1 className='lg:text-4xl text-2xl font-bold'>Tour of the Lucca Hills</h1>
