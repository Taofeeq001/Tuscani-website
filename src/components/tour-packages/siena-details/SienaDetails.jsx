      ...
      <div className='lg:px-[10%]'>
        ...
        <div className='flex gap-[3rem] lg:flex-row flex-col'>
          <div className='flex flex-col gap-2 lg:w-1/2 w-full'>
            <Image height={450} width={450} className='w-full flex justify-start' src={"/Images/s1.svg"} />
            <div className='grid lg:grid-cols-3 md:grid-cols-3 grid-cols-3 w-full gap-5'>
              <Image height={100} width={200} src={"/Images/s2.svg"} />
              <Image height={100} width={200} src={"/Images/s4.svg"} />
              <Image height={100} width={200} src={"/Images/s3.svg"} />
            </div>
          </div>
